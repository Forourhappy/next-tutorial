...
import EventSummary from '@/practiceComponents/event-detail/EventSummary';
import EventLogistics from '@/practiceComponents/event-detail/EventLogistics';
import EventContent from '@/practiceComponents/event-detail/EventContent';
